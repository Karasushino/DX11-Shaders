...
LightedTextureShader::LightedTextureShader(ID3D11Device* device, HWND hwnd) : BaseShader(device, hwnd)
{
	initShader(L"baseShadow_vs.cso", L"baseShadow_ps.cso");
}

LightedTextureShader::~LightedTextureShader()
{
...
void LightedTextureShader::initShader(const wchar_t* vsFilename, const wchar_t* psFilename)
{
...
void LightedTextureShader::setShaderParameters(ID3D11DeviceContext* deviceContext, const XMMATRIX& worldMatrix, const XMMATRIX& viewMatrix, const XMMATRIX& projectionMatrix, ID3D11ShaderResourceView* texture,
